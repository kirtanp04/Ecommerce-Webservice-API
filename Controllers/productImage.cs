...
namespace Ecommerce_Webservices.Controllers
{
    ...
    public class ProductImage : ControllerBase
    {
        ...
        [HttpPost("add")]
        public async Task<IActionResult> AddProductImage([FromBody] ProductImage objImg)
        {
            try
            {
                ...
                ProductImage objNewImg = new ProductImage();
                objNewImg = objImg;
                ...
                objRes.message = "";
                objRes.Data = "Succeesfull added images of product ";
                return Ok(objRes);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> AddMultipleProductImages([FromBody] MultipleProdImgReq objImg)
        {
            try
            {
                ...
                objRes.Data = "Successfully added all images";
                objRes.message = "";
                objRes.isSuccess = true;
                return Ok(objRes);
